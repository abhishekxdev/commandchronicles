    ...
    <header className="relative z-10 px-4 sm:px-6 py-4 sm:py-6">
      <nav className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-white">CommandChronicles</span>
        </div>
        {/* Desktop Nav */}
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-[#23231f] z-50 flex flex-col">
          ...
          <div className="flex flex-col items-center gap-6 flex-1 justify-center">
            <a href="#features" className="text-gray-300 hover:text-white text-xl transition-colors" onClick={() => setMenuOpen(false)}>
              Features
            </a>
            <a href="#pricing" className="text-gray-300 hover:text-white text-xl transition-colors" onClick={() => setMenuOpen(false)}>
              Pricing
            </a>
            <a href="#docs" className="text-gray-300 hover:text-white text-xl transition-colors" onClick={() => setMenuOpen(false)}>
              Docs
            </a>
            <Button size="lg" className="bg-black text-white w-4/5" onClick={() => setMenuOpen(false)}>
              Sign In
            </Button>
          </div>
        </div>
